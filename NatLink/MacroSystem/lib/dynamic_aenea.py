...
import aenea, dragonfly, lib.config
import aenea.proxy_actions as proxy_actions
...
class GlobalDynamicContext(DynamicContext):
    ...
    def __init__(self):
        #DynamicContext.__init__(self, None, aenea.global_context) #TODO:fixme-- aenea.global_context doesn't exist
        DynamicContext.__init__(self, None, None)
